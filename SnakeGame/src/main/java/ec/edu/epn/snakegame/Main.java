...
public class Main extends Application {
    ...
    private KeyMovements direction = KeyMovements.UP;
    ...
    public void playing() {
        ...
        switch (direction) {
            case KeyMovements.UP -> newY--;
            case KeyMovements.DOWN -> newY++;
            case KeyMovements.LEFT -> newX--;
            case KeyMovements.RIGHT -> newX++;
        }
    }
